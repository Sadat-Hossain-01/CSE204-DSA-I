...
int main() {
  for (int i = 0; i < length.size(); i++) {
    int ms = 0, qs = 0, rqs = 0, is = 0, qsi = 0, rqsi = 0, stls = 0;
    ...
    cout << "Merge Sort: " << ms * 50 << endl;
    cout << "Quick Sort: " << qs * 50 << endl;
    cout << "Randomized Quick Sort: " << rqs * 50 << endl;
    cout << "Insertion Sort: " << is * 50 << endl;
    cout << "Quick Sort with Sorted Input: " << qsi * 50 << endl;
    cout << "Randomized Quick Sort with Sorted Input: " << rqsi * 50 << endl;
    cout << "STL Sort : " << stls * 50 << endl;
    cout << endl;
  }
}